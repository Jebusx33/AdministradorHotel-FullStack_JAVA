                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="form-validate form-horizontal " id="register_form" action="svReserva" method="POST">


                                        <div class="form-group ">

                                            <label for="fechaNac" class="control-label col-lg-2">Fecha de Reserva:<span class="required">*</span></label>
                                            <div class="col-lg-2 date">
                                                <input class="form-control daterangepicker" type="date" name="fechaReserva" id="fechaReserva">
                                            </div>

                                            <label for="fechaNac" class="control-label col-lg-2">Fecha Check-In:<span class="required">*</span></label>
                                            <div class="col-lg-2 date">
                                                <input class="form-control daterangepicker" type="date" name="checkIn" id="checkIn">
                                            </div>

                                            <label for="fechaNac" class="control-label col-lg-2">Fecha Check-Out:<span class="required">*</span></label>
                                            <div class="col-lg-2 date">
                                                <input class="form-control daterangepicker" type="date" name="checkPOut" id="checkPOut">
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            <label for="nombre" class="control-label col-lg-2">Costo Total<span class="required">*</span></label>
                                            <div class="col-lg-6">
                                                <input class=" form-control" id="nombrcostoTotal" name="costoTotal" type="text" />
                                            </div>
                                        </div>
