    ...
    <section id="container" class="">
        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-user-circle-o" aria-hidden="true"></i>
                            Ingrear Empleado</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                Ingrese los datos del Empleado a registrar
                            </header>
                            <div class="panel-body">
                                <div class="form">
                                    <form class="form-validate form-horizontal " id="register_form" action="svEmpleado" method="POST">
