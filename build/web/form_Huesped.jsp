       ...
       <header class="header dark-bg">
        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-users banderaOK"aria-hidden="true"></i></i>Ingresar Huésped</h3>
                        <ol class="breadcrumb">
                            <li><i class="fa fa-home"></i><a href="panelControl.jsp">Inicio</a></li>
                            <li><i class="fa fa-users"aria-hidden="true"></i></i>Ingresar Huésped</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="form-validate form-horizontal " id="register_form" action="svHuesped" method="POST">
